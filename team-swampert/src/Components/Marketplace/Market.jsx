    ...
    return (
        <div className="antialiased font-sans bg-gray-200">
            <div className="container mx-auto px-4 sm:px-8">
                <div className="py-8">
                    <div>
                        <h2 className="text-2xl font-semibold leading-tight">MARKETPLACE</h2>
                    </div>
                    ...
                    <div className="-mx-3 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                            ...
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p className="text-gray-900 whitespace-no-wrap">Seller</p>
                                        </td>
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p className="text-gray-900 whitespace-no-wrap">
                                                Jan 21, 2020
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p className="text-gray-900 whitespace-no-wrap">Wholeseller</p>
                                        </td>
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p className="text-gray-900 whitespace-no-wrap">
                                                Jan 01, 2020
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-5 py-5 bg-white text-sm">
                                            <span
                                                ...
                                                <span className="relative">InBuy</span>
                                            </span>
                                        </td>
                                    </tr>
                                </tbody>
